# CONSTITUTION — Catalogizer-API-Client-TS

Project-specific governance for the **Catalogizer-API-Client-TS** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
